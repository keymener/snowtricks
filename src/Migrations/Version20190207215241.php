 ...
 */
final class Version20190207215241 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD date_update DATETIME DEFAULT NULL, DROP first_image_id');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE trick ADD first_image_id INT DEFAULT NULL, DROP date_update');
